# Reference - https://github.com/hposton/python-for-cybersecurity
#win32evtlog is a module encapsulating the Windows Win32 event log API
import win32evtlog
# For reading windows event log
server = "localhost"
logtype = "Security"
